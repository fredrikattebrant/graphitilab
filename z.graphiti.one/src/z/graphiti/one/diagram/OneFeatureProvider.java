...
import z.graphiti.one.features.AddDomainObjectConnectionConnectionFeature;
import z.graphiti.one.features.AddDomainObjectFeature;
import z.graphiti.one.features.CreateDomainObjectConnectionConnectionFeature;
import z.graphiti.one.features.CreateDomainObjectFeature;
import z.graphiti.one.features.LayoutDomainObjectFeature;


public class OneFeatureProvider extends DefaultFeatureProvider {

	public OneFeatureProvider(IDiagramTypeProvider dtp) {
		super(dtp);
	}
